...
prox = {
        ...
        'https':'187.109.81.238:20183'}
          
contract_id=['m']

for i in range(0,len(contract_id)):
    now_date = datetime.datetime(2018,4,2)
    print(contract_id[i])
...
#            contract_number = con.get_text(strip=True)
        ...
        try:
            ...
            data.to_csv('../../各交易所期貨持倉量/大商所/m_option/'+split_date[0]+split_date[1]+split_date[2]+'_all'+'.csv',encoding='gbk',index=None)          
